...
import { getOrderWizard, updateOrder, createFBCampaign, createDSPCampaign } from 'api/orders.graphql'
...
const OrderWizard = ({ classes, match, tabIndex, setTabIndex }) => (
  <React.Fragment>
    <Query query={getOrderWizard} variables={{ id: match.params.orderId }}>
            ...
            <React.Fragment>
              ...
              {tabIndex === 'List' && (
                <React.Fragment>
                  ...
                  <Field
                    ...
                    renderDropzone={() => (
                      <p>
                        Drag and Drop your List CSV Files here. You can upload more than one file at a time. All files uploaded together will be merged into ONE
                        LIST used for the campaign.
                      </p>
                    )}
                    multiple
                  >
              ...
              {tabIndex === 'Campaign' && (
                <React.Fragment>
                  ...
                  <Field name="campaignStartedDate" component={TextField} type="date" label="Campaign Started Date" InputLabelProps={{ shrink: true }} />
              ...
              {tabIndex === 'Reports' && (
                <React.Fragment>
                  ...
                  <ListFiles files={doc.reportFiles} editable={false} />
                </React.Fragment>
              )*/}
            </React.Fragment>
          )}
