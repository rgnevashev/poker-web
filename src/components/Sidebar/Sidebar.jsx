      ...
      <AppContext.Consumer>
        {({ user }) => (
          <div className={userWrapperClass}>
            <div className={photo}>
              <Avatar name={user.name} src={user.avatar} size={34} round={true} />
            ...
            <List className={classes.list}>
              <ListItem className={classes.item + ' ' + classes.userItem}>
                <NavLink to={'#'} className={classes.itemLink + ' ' + classes.userCollapseButton} onClick={() => this.openCollapse('openAvatar')}>
                  <ListItemText primary={user.name} disableTypography={true} className={itemText + ' ' + classes.userItemText} />
                </NavLink>
              </ListItem>
            </List>
          </div>
          ...
          <List className={classes.list}>
            {routes.map((prop, key) => {
              ...
              if (prop.collapse) {
                ...
                if (prop.accountTypes && !(prop.accountTypes || []).includes(user.accountType)) return null
                return (
                            ...
                            <ListItem key={key} className={classes.collapseItem}>
                              <NavLink to={prop.path} className={navLinkClasses}>
                                <span className={collapseItemMini}>
                                  <prop.icon style={{ fontSize: '100%', marginTop: 2 }} />
                                </span>
            ...
            <ListItem className={classes.item}>
              <NavLink to="/exit" className={classes.itemLink}>
                <ListItemIcon className={classes.itemIcon}>
                  <Icon>exit_to_app</Icon>
                </ListItemIcon>
                <ListItemText primary="Exit" disableTypography={true} className={classes.itemText} />
              </NavLink>
            </ListItem>
          </List>
        )}
